...
class UserModel extends Model{
    ...
    */
    ...
    /**
     * récupéré un user dans la base de données, grace au email
     *
     * @param string $email
     * @return array
     */
    ...
    */
    public function deleteBooking(int $id) : void 
    {
        ...
        $deleteOneBooking->execute(array(':id' => $id));
    }
     ...
     * @return void
    */
    public function addBooking(int $user_id, string $booking_date_debut, string $booking_time_debut, string $booking_date_fin, 
        string $booking_time_fin, int $number_of_seats, int $car_id
    ) : void 
    {
